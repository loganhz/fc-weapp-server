...
- [:octocat: 服务端源代码](https://github.com/loganhz/fc-weapp-server)
- [:octocat: 客户端源代码](https://github.com/loganhz/fc-weapp-client)
...
3. `git clone git@github.com:loganhz/fc-weapp-client.git` 下载当前示例的小程序客户端代码。并按照[说明](https://github.com/loganhz/fc-weapp-client/blob/master/README.md)构建，并发布小程序客户端。
...
客户端代码地址为 https://github.com/loganhz/fc-weapp-client
